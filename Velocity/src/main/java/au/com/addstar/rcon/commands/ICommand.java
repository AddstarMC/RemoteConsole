...
public interface ICommand 
{
	 ...
	 */
    String getUsageString(String label, CommandSource sender);
	 ...
	 * @return
	 */
    EnumSet<CommandSourceType> getAllowedSenders();
	 ...
	 */
    boolean onCommand(CommandSource sender, String parent, String label, String[] args) throws BadArgumentException;
	 ...
	 */
    List<String> onTabComplete(CommandSource sender, String parent, String label, String[] args);
}
